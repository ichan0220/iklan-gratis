...
if(! defined('FILE_CACHE_SUFFIX') ) 		define ('FILE_CACHE_SUFFIX', '.cache.jpg');			// What to put at the end of all files in the cache directory so we can identify them
if(! defined('FILE_CACHE_PREFIX') ) 		define ('FILE_CACHE_PREFIX', 'xnx');				// What to put at the beg of all files in the cache directory so we can identify them
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', './data/cache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if(! defined('NOT_FOUND_IMAGE') )		define ('NOT_FOUND_IMAGE', './data/cache/default.png');		// Image to serve if any 404 occurs 
if(! defined('ERROR_IMAGE') )			define ('ERROR_IMAGE', './data/cache/default.png');			// Image to serve if an error occurs instead of showing error message 
